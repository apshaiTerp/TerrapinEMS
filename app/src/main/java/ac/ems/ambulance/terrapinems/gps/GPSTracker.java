...
import ac.ems.ambulance.terrapinems.rest.PostLocationRestOperation;
...
public class GPSTracker extends Service implements LocationListener {
    ...
    //Distance is measure in 10 meters
    private final static long MIN_DISTANCE_FOR_UPDATES = 2;
    //Time for updates should be 5 seconds I believe.
    private final static long MIN_TIME_BTW_UPDATES = 1000 * 5;
    ...
    public void onLocationChanged(Location location) {
        ...
        //I think this is where I want my POST call to update location to go.
        PostLocationRestOperation restOperation = new PostLocationRestOperation(location);
        try {
